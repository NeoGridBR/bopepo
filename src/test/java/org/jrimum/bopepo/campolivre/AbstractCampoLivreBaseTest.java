...
public abstract class AbstractCampoLivreBaseTest {
	...
	protected final void testeSeNaoPermiteNumeroDaAgenciaComDigitosAcimaDoLimite(int limiteAcima)
	...
	protected final void testeSeNaoPermiteNossoNumeroComTamanhoDiferenteDoEspecificado(int nnOutLength)
			throws CampoLivreException {
	...
	protected final void testeSeNaoPermiteNumeroDaContaComCodigoAcimaDoLimite(int limiteAcima)
			throws CampoLivreException {
	...
	protected final void testeSeNaoPermiteParametroBancarioSemValor(ParametroBancario<?> parametro)
			throws IllegalArgumentException {
		// uma exceção deve ser lançada aqui
		titulo.setParametrosBancarios(new ParametrosBancariosMap(parametro, null));
	}

	protected final void testeSeNaoPermiteParametroBancarioComValorAcimaDoLimite(ParametroBancario<?> parametro,
			Integer limiteAcima) throws IllegalArgumentException {
