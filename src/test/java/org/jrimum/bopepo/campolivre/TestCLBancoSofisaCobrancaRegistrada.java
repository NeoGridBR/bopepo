 ...
 *
 */
public class TestCLBancoSofisaCobrancaRegistrada extends AbstractCLBancoSofisaBaseTest {
	...
	public void setUp() {
		...
		titulo.getContaBancaria().setAgencia(new Agencia(19, "1"));
		titulo.getContaBancaria().setNumeroDaConta(new NumeroDaConta(14995, "0"));
		titulo.getContaBancaria().setCarteira(new Carteira(121, TipoDeCobranca.COM_REGISTRO));
		titulo.setNossoNumero("0000011509");
		titulo.setParametrosBancarios(new ParametrosBancariosMap(ParametroBancoSofisa.CODIGO_DO_CONVENIO, 1554));
